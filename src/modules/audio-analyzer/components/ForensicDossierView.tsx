...
const SAMPLE_PROD_RESULT: ProductionAnalysisResult = {
  ...
  executiveVerdict: {
    commercialReadinessGrade: 'A+',
    distributionClearance: 'CERTIFIED',
    score: 98,
    executiveSummary: 'Loudness perfectly aligned to EBU R128 / ACX standard (-16.2 LUFS). Non-rhotic Australian phonetics successfully synthesized for all clinical terminology. High dynamic range preserved (14.8 dB crest factor) with zero clipping.',
    actionableFixes: []
  }
};
